package com.example.homework_10_5_1.controller;

import com.example.homework_10_5_1.entity.Person;
import com.example.homework_10_5_1.repository.MyRepository;
...
public class MyController {
    ...
    public List<Person> getByAge(@RequestParam("age") int age) {
        return repository.findByPersonData_AgeLessThan(age, Sort.by("personData.age"));
    }
